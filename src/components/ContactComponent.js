...
class Contact extends Component{
    ...
    validate(firstname, lastname, telnum, email){
        ...
        else if(this.state.touched.telnum && (telnum.length < 8 || telnum.length>8))
            errors.telnum = 'Tel number should have exactly 8 digits';
        ...
        return (
            <div className="container">
                <Breadcrumb>
                    ...
                    <BreadcrumbItem active>Concat Us</BreadcrumbItem>
                </Breadcrumb>
                ...
                <div className="row row-content">
                    ...
                    <div className="col-12 col-sm-11 offset-sm-1">
                        <div className="btn-group" role="group">
                            <a role="button" className="btn btn-primary" href="tel: +8512349089"><i className="fa fa-phone"></i>Email</a>
